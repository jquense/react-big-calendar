!(function(e, t) {
  ...
  function jt(e, t) {
    ...
    if ('fixed' === wt(e, 'position')) n = e.getBoundingClientRect()
      ...
      r.top += parseInt(i, 10) - Dt(o) || 0
      var s = String(wt(o, 'borderLeftWidth') || 0)
      r.left += parseInt(s, 10) - Ot(o) || 0
    }
      ...
      return (
        ...
        (t.prototype.render = function() {
          var e = this.props,
            ...
            M = h.start(o),
            x = h.allDay(o),
            j = c || x || Oe(M, we(D, 'day'), 'day') > 1,
            N = m.eventProp(o, M, D, i),
            C = r.createElement(
              'div',
    ...
    return (
      (n.componentDidMount = function() {
        var e,
          ...
          c = i.width,
          l = i.height,
          u = window.innerHeight + Dt(window),
  ...
  function Rr(e) {
    return (
      !(!ze(e) || ((t = e), Sr && Sr in t)) && (Ye(e) ? Cr : Mr).test(Dr(e))
    )
    var t
  }
  function kr(e, t) {
  ...
  ;(ko['[object Float32Array]'] = ko['[object Float64Array]'] = ko[
    '[object Int8Array]'
  ] = ko['[object Int16Array]'] = ko['[object Int32Array]'] = ko[
    '[object Uint8Array]'
  ] = ko['[object Uint8ClampedArray]'] = ko['[object Uint16Array]'] = ko[
    '[object Uint32Array]'
  ] = !0),
    (ko['[object Arguments]'] = ko['[object Array]'] = ko[
      '[object ArrayBuffer]'
    ] = ko['[object Boolean]'] = ko['[object DataView]'] = ko[
      '[object Date]'
    ] = ko['[object Error]'] = ko['[object Function]'] = ko[
      '[object Map]'
    ] = ko['[object Number]'] = ko['[object Object]'] = ko[
      '[object RegExp]'
    ] = ko['[object Set]'] = ko['[object String]'] = ko[
      '[object WeakMap]'
    ] = !1)
  var Po = 'object' == typeof e && e && !e.nodeType && e,
    Fo =
      Po && 'object' == typeof module && module && !module.nodeType && module,
    Lo = Fo && Fo.exports === Po && xe.process,
    Io = (function() {
      try {
    ...
    zo = Wo
      ? Ao(Wo)
      : function(e) {
          return Qe(e) && Xe(e.length) && !!ko[We(e)]
        },
  ...
  function Di(e, t) {
    ...
    return (n.cache = new (Di.Cache || Ur)()), n
  }
  Di.Cache = Ur
  var Mi = 500
  var xi,
  ...
  var Ai = 1 / 0,
    ...
    Fi = Pi ? Pi.toString : void 0
  function Li(e) {
    if ('string' == typeof e) return e
    if (go(e)) return ki(e, Li) + ''
    if (tt(e)) return Fi ? Fi.call(e) : ''
    var t = e + ''
  ...
  function na(e, t, n) {
    var r = +Z(n.start(e), 'day') - +Z(n.start(t), 'day'),
      o = Oe(n.start(e), we(n.end(e), 'day'), 'day'),
      i = Oe(n.start(t), we(n.end(t), 'day'), 'day')
    return (
      r ||
          ...
          r.createElement(
            ...
            r.createElement(
              ...
              !!D.length &&
                r.createElement(
                  la,
                  a({ segments: D, onShowMore: this.handleShowMore }, x)
                )
            )
          )
        )
  ...
  var Ya = {
    ...
    'no-overlap': function(e) {
      ...
      for (var w = 0; w < t.length; ++w) {
        ...
        var D = 0 === E.idx ? 0 : 3
        ;(E.style.width = 'calc(' + E.size + '% - ' + D + 'px)'),
          (E.style.height = 'calc(' + E.style.height + '% - 2px)'),
          (E.style.xOffset = 'calc(' + E.style.left + '% + ' + D + 'px)')
      }
      return t
    },
  }
    ...
    function t(t) {
      ...
      return (
        ...
        (o.handleResize = function() {
          Pt(o.rafHandle), (o.rafHandle = Ft(o.checkOverflow))
        }),
  ...
  function ms(e, t, n) {
    '__proto__' == t && ka
      ? ka(e, t, { configurable: !0, enumerable: !0, value: n, writable: !0 })
      : (e[t] = n)
  }
  ds.propTypes = {}
  ...
  var _s = 'object' == typeof e && e && !e.nodeType && e,
    ...
    Os = Ss && Ss.exports === _s ? je.Buffer : void 0,
    Ds = Os ? Os.allocUnsafe : void 0
  ...
  var Cs = /\w*$/
  var Rs = Ne ? Ne.prototype : void 0,
    ks = Rs ? Rs.valueOf : void 0
  ...
  function Qs(e, t, n) {
    ...
    switch (t) {
      ...
      case Ws:
        return new a()
      case Hs:
        return (r = e), ks ? Object(ks.call(r)) : {}
    }
  }
  ...
  function gc(e, t) {
    return (
      null ==
        (e = (function(e, t) {
          return t.length < 2 ? e : Hi(e, De(t, 0, -1))
        })(e, (t = Ii(t, e)))) ||
      delete e[
  ...
  function Dc(e) {
    return (null == e ? 0 : e.length) ? Da(e, 1) : []
  }
  var Mc = (function(e) {
      return Ia(Ra(e, void 0, Dc), e + '')
    })(function(e, t) {
      var n = {}
      if (null == e) return n
      var r = !1
    ...
    return (
      ...
      (n.render = function() {
        ...
        var v = this.getView(),
          ...
          _ = g.viewNames,
          S = b.toolbar || ds,
          O = v.title(u, { localizer: E, length: p })
        return r.createElement(
          'div',
          a({}, l, {
  ...
  var kc = (function e(t, n, o) {
      ...
      !(function(e) {
        ...
        if (
          ('function' == typeof e.getDerivedStateFromProps &&
            ((t.componentWillMount = O), (t.componentWillReceiveProps = D)),
          'function' == typeof t.getSnapshotBeforeUpdate)
        ) {
    ...
    })(Rc, { view: 'onView', date: 'onNavigate', selected: 'onSelectEvent' }),
    Ac = function(e, t, n) {
      var r = e.start,
        o = e.end
