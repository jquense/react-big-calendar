!(function(e, t) {
  ...
  var D = { PREVIOUS: 'PREV', NEXT: 'NEXT', TODAY: 'TODAY', DATE: 'DATE' },
    T = {
      MONTH: 'month',
      WEEK: 'week',
      WORK_WEEK: 'work_week',
  ...
  function Ye(e) {
    return null != e && Ue(e.length) && !Ve(e)
  }
      ...
      return (
        ...
        (t.prototype.render = function() {
          var e = this.props,
            ...
            T = h.start(o),
            x = h.allDay(o),
            C = c || x || Ee(T, ge(D, 'day'), 'day') > 1,
            j = m.eventProp(o, T, D, i),
            N = r.createElement(
              'div',
          ...
          return r.createElement(
            ...
            r.createElement(
              ...
              a({}, _, {
                tabIndex: 0,
                style: a({}, j.style, {}, t),
                className: M('rbc-event', n, j.className, {
                  'rbc-selected': i,
                  'rbc-event-allday': C,
  ...
  for (
    ...
    if (Wt && navigator.userAgent.indexOf(Ht[Bt]) >= 0) {
      Vt = 1
      break
    }
  var Ut =
  ...
  function Gt(e) {
    ...
    var t = $t(e),
      ...
      r = t.overflowX,
      o = t.overflowY
    return /(auto|scroll|overlay)/.test(n + o + r) ? e : Gt(Xt(e))
  }
  var qt = Wt && !(!window.MSInputMethodContext || !document.documentMode),
    Kt = Wt && /MSIE 10/.test(navigator.userAgent)
  function Zt(e) {
    return 11 === e ? qt : 10 === e ? Kt : qt || Kt
  }
  function Jt(e) {
    ...
    var i = e.flip,
      ...
      T = (function(e, n, r) {
        ...
        a({}, f, {
          ...
          enableEvents: e.show,
          modifiers: a({}, D, {
            preventOverflow: a({ padding: l || 5 }, D.preventOverflow),
            arrow: a({}, D.arrow, { enabled: !!g, element: g }),
            flip: a({ enabled: !!i }, D.preventOverflow),
          }),
        })
      ),
      x = T.styles,
  ...
  function jr(e) {
    return (
      !(!Fe(e) || ((t = e), Er && Er in t)) && (Ve(e) ? Cr : Or).test(Sr(e))
    )
    var t
  }
  function Nr(e, t) {
  ...
  function pi(e, t, n, r, o, i) {
        ...
        a || Io(e)
          ...
          : (function(e, t, n, r, o, i, a) {
              switch (n) {
                ...
                case lo:
                  return !(
                    e.byteLength != t.byteLength || !i(new qr(e), new qr(t))
                  )
                case eo:
                case to:
                case oo:
    ...
    return (
      ...
      (function(e, t, n, r, o, i) {
        ...
        for (var l = c; l--; ) {
          var u = s[l]
          if (!(a ? u in t : qo.call(t, u))) return !1
        }
        var f = i.get(e)
  ...
  function Ui(e, t) {
    return Ei(e) && vi(t)
      ...
      : function(n) {
          ...
          return void 0 === r && r === t ? Hi(n, e) : di(t, r, Vi | Bi)
        }
  }
  function Yi(e) {
    return e
      ...
      return (
        ...
        (t.renderHeadingCell = function(e, n) {
          ...
          return o({
            date: e,
            key: 'header_' + n,
            className: M('rbc-date-cell', K(e, i(), 'day') && 'rbc-now'),
          })
        }),
        ...
        return (
          ...
          (t.renderWeek = function(e, n) {
            var o = t.props,
              ...
              g = m.rowLimit
            return (
              (i = ma(i, e[0], e[e.length - 1], d)).sort(function(e, t) {
                return ea(e, t, d)
              }),
              r.createElement(pa, {
                key: n,
          ...
          (t.readerDateHeading = function(e) {
            ...
            return r.createElement(
              'div',
              a({}, i, {
                className: M(o, p && 'rbc-off-range', d && 'rbc-current'),
              }),
              r.createElement(v, {
                label: m,
                date: n,
        ...
        return r.createElement(
          ...
          o.map(function(e, o) {
            ...
            return r.createElement(
              ...
              r.createElement(
                'div',
                a({}, i, { className: M('rbc-time-slot', i.className) }),
                t && t(e, o)
              )
            )
          })
    ...
    return r.createElement(
      ...
      r.createElement(
        'div',
        {
          ...
          className: M('rbc-event', o, S.className, {
            'rbc-selected': l,
    ...
    return (
        ...
        return e.map(function(e, n) {
          ...
          return r.createElement(
            'div',
            {
              key: n,
              style: d,
              className: M('rbc-header', p, K(e, u, 'day') && 'rbc-today'),
            },
            a
              ? r.createElement(
                  'a',
      ...
      (n.render = function() {
        var e = this,
          ...
          b = void 0 === y ? qa : y,
          w = {}
        m && (w[o ? 'marginLeft' : 'marginRight'] = Ga() + 'px')
        ...
        return r.createElement(
          'div',
          {
            style: w,
            ref: d,
            className: M('rbc-time-header', m && 'rbc-overflowing'),
          },
          r.createElement(
            'div',
            {
    ...
    return (
      ...
      (o.render = function() {
        ...
        return (
          ...
          r.createElement(
            'div',
            { className: M('rbc-time-view', c && 'rbc-time-view-resources') },
            r.createElement(Ka, {
              range: n,
              events: b,
              width: o,
        ...
        return 1 == this.props.views.length && 'month' == this.props.views[0]
          ? r.createElement(
              ...
              r.createElement(
                ...
                {
                  type: 'button',
                  onClick: this.navigate.bind(null, D.PREVIOUS),
                },
          ...
          : r.createElement(
              ...
              r.createElement(
                ...
                r.createElement(
                  ...
                  {
                    type: 'button',
                    onClick: this.navigate.bind(null, D.TODAY),
                  },
                  t.today
                ),
                r.createElement(
  ...
  var gs = 'object' == typeof e && e && !e.nodeType && e,
    ...
    bs = ys && ys.exports === gs ? De.Buffer : void 0,
    ws = bs ? bs.allocUnsafe : void 0
  var Es = Bo(Object.getPrototypeOf, Object),
  ...
  function Gs(e, t, n) {
    ...
    switch (t) {
      ...
      case Rs:
        return (
          ((i = new (o = e).constructor(o.source, Ds.exec(o))).lastIndex =
            o.lastIndex),
          i
        )
      case As:
        ...
        if (
          ((a =
            c || p
              ? {}
              : (function(e) {
                  return 'function' != typeof e.constructor || Vo(e)
                    ? {}
                    : Ks(Es(e))
                })(e)),
          !s)
          ...
          return Array.isArray(o)
            ? (function(e, t, n) {
                ...
                if (((t = Xi(t)), null == n)) {
                  ...
                  n = o ? (r ? new i() : []) : Fe(e) && Ve(i) ? Ks(Es(e)) : {}
                }
                return (
                  (o ? ls : Ma)(e, function(e, r, o) {
                    return t(n, e, r, o)
                  }),
                  n
                )
    ...
    return (
      ...
      (n.render = function() {
        ...
        var y = this.getView(),
          ...
          O = b.viewNames,
          D = E.toolbar || cs,
          T = y.title(u, { localizer: S, length: p })
        return r.createElement(
          'div',
          a({}, l, {
            className: M(c, 'rbc-calendar', g.rtl && 'rbc-rtl'),
            style: i,
          }),
          n &&
            r.createElement(D, {
