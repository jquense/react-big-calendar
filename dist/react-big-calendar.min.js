!(function(e, t) {
  ...
  function Ye(e) {
    return 0 === Ce(e) && 0 === je(e) && 0 === ke(e) && 0 === Ne(e)
  }
  function $e(e, t, n) {
  ...
  function On(e, t) {
    ...
    if ((e !== c && t !== c) || r.contains(o))
      return 'BODY' === (s = (a = c).nodeName) ||
        ...
        : c
    var l = Dn(e)
    return l.host ? On(l.host, t) : On(e, Dn(t).host)
  }
  function Mn(e) {
    var t =
        'top' ===
  ...
  function zn(e, t, n) {
    ...
    return Pn(n, r ? Ln(t) : On(t, bn(n)), r)
  }
  function Hn(e) {
  ...
  function Yn(e, t, n) {
    return (
      (void 0 === n
        ...
        e.enabled &&
          mn(n) &&
          ((t.offsets.popper = Rn(t.offsets.popper)),
          (t.offsets.reference = Rn(t.offsets.reference)),
          (t = n(t, e)))
      }),
      t
    )
        ...
        arrow: {
          ...
          fn: function(e, t) {
            ...
            s[d] - h < a[f] && (e.offsets.popper[f] -= a[f] - (s[d] - h)),
              ...
              (e.offsets.popper = Rn(e.offsets.popper))
            var m = s[f] + s[l] / 2 - h / 2,
  ...
  var Or,
    Mr = Function.prototype.bind.call(Function.prototype.call, [].slice)
  function Tr(e, t) {
    if (!Or) {
      var n = document.body,
        r =
  ...
  var Cr = (function() {
    ...
    return (
      ...
      (t.isSelected = function(e) {
        ...
        return !(!t || !this.selecting) && Ar(t, Rr(e))
      }),
      (t.filter = function(e) {
  ...
  var Ei = no(Ze, 'DataView'),
    ...
    Ni = Xr(Di),
    ki = st
  ;((Ei && '[object DataView]' != ki(new Ei(new ArrayBuffer(1)))) ||
    (ro && '[object Map]' != ki(new ro())) ||
    (_i && '[object Promise]' != ki(_i.resolve())) ||
    (Si && '[object Set]' != ki(new Si())) ||
  ...
  var xa,
    Na = function(e, t, n) {
      return (
        ...
        (function(e, t, n, r) {
          for (
            var o = -1, i = Ta(Ma((t - e) / (n || 1)), 0), a = Array(i);
            i--;
          ...
          r.createElement(
            ...
            r.createElement(
              ...
              !!O.length &&
                r.createElement(
                  Ca,
                  a({ segments: O, onShowMore: this.handleShowMore }, T)
                )
            )
          )
        )
      ...
      return (
        ...
        (o.render = function() {
          var e = this.props,
            ...
            o = e.className,
            i = (function(e, t, n) {
              t = (n ? wt(e, t, n) : void 0 === t) ? 1 : Ft(At(t), 0)
              var r = null == e ? 0 : e.length
              if (!r || t < 1) return []
              for (var o = 0, i = 0, a = Array(Rt(r / t)); o < r; )
                a[i++] = Ge(e, o, (o += t))
              return a
            })(
              (function(e, t) {
                for (var n = ze(e, t), r = He(e, t), o = []; Oe(n, r, 'day'); )
      ...
      return (
        ...
        (t._selectable = function() {
          var e = n.findDOMNode(re(t)),
            ...
            i = function(n) {
              var r = t.slotMetrics.closestSlotFromPoint(n, Rr(e))
          ...
          r.on('selecting', o),
            ...
            r.on('beforeSelect', function(e) {
              if ('ignoreEvents' === t.props.selectable)
                return !kr(n.findDOMNode(re(t)), e)
            }),
            r.on('click', function(e) {
              return s(e, 'click')
            }),
    ...
    return (
      ...
      (o.render = function() {
        var e = this.props,
          ...
          a = e.accessors,
          c = e.localizer,
          l = e.invertResourcesAndDates,
          u = e.getters,
          f = u.dayProp,
          p = s(u, ['dayProp']),
          d = e.components,
          h = d.eventContainerWrapper,
          m = s(d, ['eventContainerWrapper']),
          v = this.slotMetrics,
          g = this.state,
          y = g.selecting,
          b = g.top,
  ...
  ws.propTypes = {}
  var Ss = { display: 'flex', flexDirection: 'column' },
    Ds = { margin: 0 },
    Os = function(e) {
      var t = e.title,
        n = e.mins
      return r.createElement(
        'div',
        { style: Ss },
        r.createElement('p', { style: Ds }, t),
        r.createElement('p', { style: Ds }, n)
      )
    }
  Os.propTypes = {}
  var Ms = (function(e) {
  ...
  var Ts = (function(e) {
    ...
    var n = t.prototype
    return (
      (n.renderHeaderCells = function() {
        var e = this.props,
          t = e.resources,
          n = e.date,
          o = e.accessors,
          i = e.components.resourceHeader,
          a = void 0 === i ? Os : i
        return r.createElement(
          'div',
          ...
          r.createElement(
            'div',
            { className: 'rbc-row-resource inverted', key: 'resource_other' },
            r.createElement(a, {
              index: 1e3,
              title: 'other',
              mins: 0,
      ...
      (n.render = function() {
        var e = this,
          ...
          p = t.getters.dayProp,
          d = t.components,
          h = d.timeGutterHeader,
          m = d.header,
          v = void 0 === m ? Ia : m,
          g = {}
        f && (g[c ? 'marginLeft' : 'marginRight'] = _s() + 'px')
        var y = n()
        return r.createElement(
          'div',
          {
            style: g,
            ref: u,
            className: X('rbc-time-header', f && 'rbc-overflowing'),
          },
          r.createElement(
            'div',
            {
          ...
          l.map(function(t, n) {
            var s = p(t),
              ...
              u = s.style,
              f = i(t),
              d = o.format(t, 'dayFormat'),
              h = r.createElement(v, { date: t, label: d, localizer: o })
            return r.createElement(
              'div',
              { className: 'rbc-time-header-content inverted', key: t || n },
              r.createElement(
                'div',
                {
                  className:
                  ...
                  f
                    ? r.createElement(
                        'a',
                        {
                          href: '#',
                          onClick: function(n) {
                            return e.handleHeaderClick(t, f, n)
                          },
                        },
                        h
                      )
  ...
  var Ns = (function(e) {
    function t(t) {
      ...
      return (
        ...
        (o.memoizedResources = Ra(function(e, t) {
          return (function(e, t) {
            return {
              map: function(n) {
                return e
              ...
              groupEvents: function(n, r) {
                var o = new Map()
                return e
                  ? (n.forEach(function(e) {
                      var n,
                        i = t.resource(e)
                      n = r.includes(i) ? 'other' : t.resource(e) || xs
                      var a = o.get(n) || []
                      a.push(e), o.set(n, a)
                    }),
                    o)
    ...
    return (
      ...
      (o.renderEvents = function(e, t, n, o, i) {
        var s = this,
          c = this.props,
          l = c.min,
          u = c.max,
          ...
          m = c.invertResourcesAndDates,
          v = this.memoizedResources(this.props.resources, p),
          g = v.groupEvents(t, i),
          y = function(e, t, n, o, c, m, v) {
            var y = (g.get(o) || []).filter(function(e) {
                return xe(t, p.start(e), p.end(e), 'day')
              }),
              b = (g.get('other') || []).filter(function(e) {
                return xe(t, p.start(e), p.end(e), 'day')
              })
            return r.createElement(
              r.Fragment,
        ...
        if (m) {
          ...
          return e.map(function(e, t) {
            return v.map(function(r, o) {
              var a = r[0],
                s = r[1]
              return !i.includes(a) && y(n, e, t, a, s, o, b === o + 1)
            })
          })
        }
      ...
      (o.render = function() {
        ...
        var w = [],
          ...
          S = []
        return (
          this.props.resources.forEach(function(e) {
            return e.isPartTime ? S.push(e.resourceId) : _.push(e.resourceId)
          }),
  ...
  ;(js.propTypes = {}),
    (js.defaultProps = Ns.defaultProps),
  ...
  function Vs(e, t, n) {
    var r = e[t]
    ;(Us.call(e, t) && Xe(r, n) && (void 0 !== n || t in e)) || Hs(e, t, n)
  }
  function Bs(e, t, n, r) {
    var o = !n
    n || (n = {})
    for (var i = -1, a = t.length; ++i < a; ) {
      ...
      void 0 === c && (c = e[s]), o ? Hs(n, s, c) : Vs(n, s, c)
    }
    return n
  }
  ...
  function Gs(e) {
    return vt(e) ? fi(e, !0) : $s(e)
  }
  var Xs = 'object' == typeof e && e && !e.nodeType && e,
    qs =
      Xs && 'object' == typeof module && module && !module.nodeType && module,
    Ks = qs && qs.exports === Xs ? Ze.Buffer : void 0,
    Zs = Ks ? Ks.allocUnsafe : void 0
  var Js = hi(Object.getPrototypeOf, Object),
    Qs = Object.getOwnPropertySymbols
      ? function(e) {
          for (var t = []; e; ) Wo(t, Yo(e)), (e = Js(e))
          return t
        }
      : Uo
  function ec(e) {
  ...
  ;(Hc[Lc] = Hc['[object Array]'] = Hc['[object ArrayBuffer]'] = Hc[
    '[object DataView]'
  ] = Hc['[object Boolean]'] = Hc['[object Date]'] = Hc[
    '[object Float32Array]'
  ] = Hc['[object Float64Array]'] = Hc['[object Int8Array]'] = Hc[
    '[object Int16Array]'
  ] = Hc['[object Int32Array]'] = Hc['[object Map]'] = Hc[
    '[object Number]'
  ] = Hc[zc] = Hc['[object RegExp]'] = Hc['[object Set]'] = Hc[
    '[object String]'
  ] = Hc['[object Symbol]'] = Hc['[object Uint8Array]'] = Hc[
    '[object Uint8ClampedArray]'
  ] = Hc['[object Uint16Array]'] = Hc['[object Uint32Array]'] = !0),
    (Hc['[object Error]'] = Hc[Ic] = Hc['[object WeakMap]'] = !1)
  ...
  function Kc(e) {
    return (function(e) {
      if (!Et(e) || st(e) != Bc) return !1
      var t = Js(e)
      if (null === t) return !0
      var n = Xc.call(t, 'constructor') && t.constructor
      return 'function' == typeof n && n instanceof n && Gc.call(n) == qc
    })(e)
      ? void 0
      : e
  }
  ...
  var Jc = (function(e) {
    ...
    tl = cs(function(e, t) {
      ...
      for (o && wt(t[0], t[1], o) && (r = 1); ++n < r; )
        for (var i = t[n], a = Gs(i), s = -1, c = a.length; ++s < c; ) {
          var l = a[s],
            u = e[l]
          ;(void 0 === u || (Xe(u, Qc[l]) && !el.call(e, l))) && (e[l] = i[l])
        }
      return e
    })
  var nl = function(e) {
      ...
      return (
          ...
          return Array.isArray(o)
            ? (function(e, t, n) {
                ...
                if (((t = ya(t)), null == n)) {
                  ...
                  n = o ? (r ? new i() : []) : ct(e) && dt(i) ? Tc(Js(e)) : {}
                }
                return (
                  (o ? zs : Ka)(e, function(e, r, o) {
                    return t(n, e, r, o)
                  }),
                  n
                )
        ...
        (t.handleNavigate = function(e, n) {
          var r = t.props,
            ...
            p = c()
          l(
            (i = Is(f, a({}, u, { action: e, date: n || i || p, today: p }))),
            o,
            e
          ),
