!(function(e, t) {
  ...
  var T = { PREVIOUS: 'PREV', NEXT: 'NEXT', TODAY: 'TODAY', DATE: 'DATE' },
    ...
    j = Object.keys(x).map(function(e) {
      return x[e]
    }),
  ...
  var Me =
    ...
    Te = Me || De || Function('return this')(),
    xe = Te.Symbol,
    je = Object.prototype,
    Ne = je.hasOwnProperty,
    Ce = je.toString,
    ke = xe ? xe.toStringTag : void 0
      ...
      return (
        ...
        (t.prototype.render = function() {
          var e = this.props,
            ...
            T = h.start(o),
            x = h.allDay(o),
            j = c || x || _e(T, ye(M, 'day'), 'day') > 1,
            N = m.eventProp(o, T, M, i),
            C = r.createElement(
              'div',
  ...
  function Wr(e) {
    return (
      !(!Ie(e) || ((t = e), Cr && Cr in t)) && (Ue(e) ? zr : Pr).test(Rr(e))
    )
    var t
  }
  function Hr(e, t) {
  ...
  var Ro = Object.prototype,
    Po = Ro.hasOwnProperty,
    Ao = Ro.propertyIsEnumerable,
    Lo = ko(
      (function() {
        return arguments
      })()
        ...
        return (
          ...
          (t.handleShowMore = function(e, r, o, i, a) {
            ...
            if ((t.clearSelection(), c)) {
              var d = xt(o, n.findDOMNode(L(t)))
              t.setState({
                overlay: { date: r, events: e, position: d, target: a },
              })
            } else C(l, [r, f(r) || x.DAY])
            C(u, [e, r, i])
          }),
          (t._bgRows = []),
          (t._pendingSelection = []),
          ...
          return (function(e) {
            ...
            return (
              a.forEach(function(e) {
                if (qa(l, e, n)) {
                  for (
                    var t = !1, r = c[c.length - 1], o = 0;
                    o < r.length;
                    o++
                  ) {
                    var i = r[o]
                    if (!qa(i[i.length - 1], e, n)) {
                      i.push(e), (t = !0)
                      break
                    }
                  }
  ...
  ;(Ja.propTypes = {}),
    (Ja.defaultProps = { dragThroughEvents: !0, timeslots: 2 })
  var Qa,
    es = (function(e) {
      function t() {
  ...
  function ns(e) {
    if (((!Qa && 0 !== Qa) || e) && jt) {
      ...
      ;(t.style.position = 'absolute'),
        ...
        (Qa = t.offsetWidth - t.clientWidth),
    ...
    return (
      ...
      (n.render = function() {
        var e = this,
          ...
          b = void 0 === y ? rs : y,
          w = {}
        m && (w[o ? 'marginLeft' : 'marginRight'] = ns() + 'px')
    ...
    function t(t) {
      ...
      return (
        ...
        (o.handleResize = function() {
          Pt(o.rafHandle), (o.rafHandle = At(o.checkOverflow))
        }),
              ...
              groupEvents: function(n) {
                ...
                return e
                  ? (n.forEach(function(e) {
                      ;(t.resource(e) || is).forEach(function(t) {
                        var n = r.get(t) || []
                        n.push(e), r.set(t, n)
                      })
                    }),
    ...
    return (
      ...
      (t.prototype.render = function() {
        var e = this.props,
          ...
          o = s(e, ['date']),
          i = t.range(n)
        return r.createElement(as, a({}, o, { range: i, eventOffset: 10 }))
      }),
      t
    )
  })(r.Component)
  ...
  var cs = (function(e) {
    ...
    return (
      ...
      (t.prototype.render = function() {
        ...
        return r.createElement(as, a({}, o, { range: i, eventOffset: 15 }))
      }),
      t
    )
  })(r.Component)
    ...
    return (
      ...
      (t.prototype.render = function() {
        var e = this.props,
          ...
          n = s(e, ['date']),
          o = ls(t, this.props)
        return r.createElement(as, a({}, n, { range: o, eventOffset: 15 }))
      }),
      t
    )
  })(r.Component)
  ...
  ;(us.propTypes = {}),
    (us.defaultProps = as.defaultProps),
    (us.range = ls),
    (us.navigate = cs.navigate),
            ...
            if (n.tbodyRef.current) {
              ...
              if (t) {
                var r,
                  ...
                  a = n._widths || []
                ;(n._widths = [ts(t.children[0]), ts(t.children[1])]),
  ...
  ;(ps.propTypes = {}),
    ...
    (ps.range = function(e, t) {
      ...
      return {
        start: e,
        end: X(e, void 0 === n ? ps.defaultProps.length : n, 'day'),
      }
    }),
  ...
  function ys(e, t, n) {
    '__proto__' == t && Wa
      ? Wa(e, t, { configurable: !0, enumerable: !0, value: n, writable: !0 })
      : (e[t] = n)
  }
  vs.propTypes = {}
  ...
  function ws(e, t, n) {
    var r = e[t]
    ;(bs.call(e, t) && Se(r, n) && (void 0 !== n || t in e)) || ys(e, t, n)
  }
  function Es(e, t, n, r) {
    var o = !n
    n || (n = {})
    for (var i = -1, a = t.length; ++i < a; ) {
      ...
      void 0 === c && (c = e[s]), o ? ys(n, s, c) : ws(n, s, c)
    }
    return n
  }
  ...
  function Ss(e) {
    return $e(e) ? Ko(e, !0) : Os(e)
  }
  var Ms = 'object' == typeof e && e && !e.nodeType && e,
    Ds =
      Ms && 'object' == typeof module && module && !module.nodeType && module,
    Ts = Ds && Ds.exports === Ms ? Te.Buffer : void 0,
    xs = Ts ? Ts.allocUnsafe : void 0
  var js = Qo(Object.getPrototypeOf, Object),
    Ns = Object.getOwnPropertySymbols
      ? function(e) {
          for (var t = []; e; ) So(t, No(e)), (e = js(e))
          return t
        }
      : To
  function Cs(e) {
  ...
  var Ps = /\w*$/
  var As = xe ? xe.prototype : void 0,
    Ls = As ? As.valueOf : void 0
  ...
  function nc(e, t, n) {
    ...
    switch (t) {
      ...
      case Hs:
        return (
          ((i = new (o = e).constructor(o.source, Ps.exec(o))).lastIndex =
            o.lastIndex),
          i
        )
      case Vs:
        return new a()
      case Ys:
        return (r = e), Ls ? Object(Ls.call(r)) : {}
    }
  }
    ...
    if (sc(e))
      return (
        e.forEach(function(r, o) {
          a.set(o, bc(r, t, n, o, e, i))
        }),
        a
      )
    var h = l ? (c ? Cs : ri) : c ? keysIn : ni,
      m = u ? void 0 : h(e)
    return (
      gs(m || e, function(r, o) {
        m && (r = e[(o = r)]), ws(a, o, bc(r, t, n, o, e, i))
      }),
      a
    )
  }
  ...
  ;(yc[hc] = yc['[object Array]'] = yc['[object ArrayBuffer]'] = yc[
    '[object DataView]'
  ] = yc['[object Boolean]'] = yc['[object Date]'] = yc[
    '[object Float32Array]'
  ] = yc['[object Float64Array]'] = yc['[object Int8Array]'] = yc[
    '[object Int16Array]'
  ] = yc['[object Int32Array]'] = yc['[object Map]'] = yc[
    '[object Number]'
  ] = yc[gc] = yc['[object RegExp]'] = yc['[object Set]'] = yc[
    '[object String]'
  ] = yc['[object Symbol]'] = yc['[object Uint8Array]'] = yc[
    '[object Uint8ClampedArray]'
  ] = yc['[object Uint16Array]'] = yc['[object Uint32Array]'] = !0),
    (yc['[object Error]'] = yc[mc] = yc['[object WeakMap]'] = !1)
  var Ec = '[object Object]',
    _c = Function.prototype,
    Oc = Object.prototype,
    Sc = _c.toString,
    Mc = Oc.hasOwnProperty,
    Dc = Sc.call(Object)
  function Tc(e) {
    return (function(e) {
      if (!Ze(e) || Fe(e) != Ec) return !1
      var t = js(e)
      if (null === t) return !0
      var n = Mc.call(t, 'constructor') && t.constructor
      return 'function' == typeof n && n instanceof n && Sc.call(n) == Dc
    })(e)
      ? void 0
      : e
  }
  ...
  var jc = (function(e) {
    ...
    kc = $a(function(e, t) {
      ...
      for (o && Ke(t[0], t[1], o) && (r = 1); ++n < r; )
        for (var i = t[n], a = Ss(i), s = -1, c = a.length; ++s < c; ) {
          var l = a[s],
            u = e[l]
          ;(void 0 === u || (Se(u, Nc[l]) && !Cc.call(e, l))) && (e[l] = i[l])
        }
      return e
    })
  var Rc = function(e) {
      ...
      return (
          ...
          return Array.isArray(o)
            ? (function(e, t, n) {
                ...
                if (((t = ra(t)), null == n)) {
                  ...
                  n = o ? (r ? new i() : []) : Ie(e) && Ue(i) ? oc(js(e)) : {}
                }
                return (
                  (o ? gs : Pa)(e, function(e, r, o) {
                    return t(n, e, r, o)
                  }),
                  n
                )
        ...
        (t.handleNavigate = function(e, n) {
          var r = t.props,
            ...
            d = c()
          l(
            (i = ms(f, a({}, u, { action: e, date: n || i || d, today: d }))),
            o,
            e
          ),
  ...
  var Lc = (function e(t, n, o) {
    ...
    })(Ac, { view: 'onView', date: 'onNavigate', selected: 'onSelectEvent' }),
    Fc = function(e, t, n) {
      var r = e.start,
        o = e.end
  ...
  var Yc = { eventWrapper: i, timeSlotWrapper: i, dateCellWrapper: i }
  ;(e.Calendar = Lc),
    (e.DateLocalizer = R),
    (e.Navigate = T),
    (e.Views = x),
