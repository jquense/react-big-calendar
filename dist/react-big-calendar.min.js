!(function (e, t) {
  ...
  var hb = (function (e) {
    ...
    mb = {
      propTypes: {
        slotMetrics: we.object.isRequired,
        selected: we.object,
        isAllDay: we.bool,
        accessors: we.object.isRequired,
        localizer: we.object.isRequired,
              ...
              return se.createElement(
                ...
                n.reduce(function (t, n, o) {
                  var i = n.event,
                    ...
                    c = '_lvl_' + o,
                    f = l - a,
                    d = mb.renderEvent(e.props, i)
                  return (
                    f && t.push(mb.renderSpan(r, f, ''.concat(c, '_gap'))),
                    t.push(mb.renderSpan(r, s, c, d)),
                    (a = u + 1),
                    t
                  )
                }, [])
  ...
  ;(gb.propTypes = {}), (gb.defaultProps = i({}, mb.defaultProps))
              ...
              for (
                ...
                if (s) {
                  ...
                  if (this.canRenderSlotEvent(c, d)) {
                    var v = mb.renderEvent(this.props, s)
                    p && i.push(mb.renderSpan(n, p, l + '_gap')),
                      i.push(mb.renderSpan(n, d, l, v)),
                      (a = o = f + 1)
                  } else
                    p && i.push(mb.renderSpan(n, p, l + '_gap')),
                      i.push(mb.renderSpan(n, 1, l, this.renderShowMore(t, o))),
                      (a = o += 1)
                } else o++
              }
  ...
  Zw.defaultProps = i({}, mb.defaultProps)
  var ek = function (e) {
      var t = e.children
      return se.createElement(
        'div',
        ...
        return (
          ...
          (e.renderWeek = function (t, n) {
            var r = e.props,
              ...
              g = h.rowLimit,
              y = ck(Lt(o), t[0], t[t.length - 1], d, c)
            return (
              y.sort(function (e, t) {
                return Hw(e, t, d, c)
              }),
  ...
  var vk = Mg,
    hk = sg,
    mk = Ht ? Ht.isConcatSpreadable : void 0
  var gk = ug,
    yk = function (e) {
  ...
  function cE(e) {
    ...
    var t = e.dayLayoutAlgorithm,
      n = t
    return t in uE && (n = uE[t]), sE(n) ? n.apply(this, arguments) : []
  }
  var fE = (function (e) {
    p(r, e)
    var n = g(r)
  ...
  var vE = function (e) {
    ...
    hE = se.forwardRef(function (e, t) {
      return se.createElement(vE, Object.assign({}, e, { innerRef: t }))
    }),
    mE = ['dayProp'],
  ...
  var bE = function (e) {
    ...
    wE = se.forwardRef(function (e, t) {
      return se.createElement(bE, Object.assign({ gutterRef: t }, e))
    }),
    kE = function (e) {
      var t = e.label
  ...
  ;(zE.defaultProps = xE.defaultProps),
    ...
    (LE.defaultProps = { length: 30 }),
    (LE.range = function (e, t) {
      var n = t.length,
        r = void 0 === n ? LE.defaultProps.length : n
      return { start: e, end: t.localizer.add(e, r, 'day') }
    }),
    (LE.navigate = function (e, t, n) {
      var r = n.length,
        o = void 0 === r ? LE.defaultProps.length : r,
        a = n.localizer
      switch (t) {
        case De.PREVIOUS:
  ...
  var hS = function (e, t) {
    ...
    mS = ey(Object.getPrototypeOf, Object),
    gS = ug,
    yS = mS,
    bS = yg,
    wS = pg,
  ...
  var ex = bk
  var tx = function (e) {
      return (null == e ? 0 : e.length) ? ex(e, 1) : []
    },
    nx = Uk,
    rx = Qk
  var ox = Wb,
    ...
    cx = MS,
    fx = (function (e) {
      return rx(nx(e, void 0, tx), e + '')
    })(function (e, t) {
      var n = {}
      if (null == e) return n
      var r = !1
      ;(t = ox(t, function (t) {
        return (t = lx(t, e)), r || (r = t.length > 1), t
      })),
        ux(e, cx(e), n),
        r && (n = ax(n, 7, sx))
      for (var o = t.length; o--; ) ix(n, t[o])
      return n
    }),
    dx = Zk,
    px = At,
    ...
    yx = dx(function (e, t) {
      ...
      var n = -1,
        r = t.length,
        o = r > 2 ? t[2] : void 0
      for (o && vx(t[0], t[1], o) && (r = 1); ++n < r; )
        for (var a = t[n], i = hx(a), l = -1, u = i.length; ++l < u; ) {
          var s = i[l],
            c = e[s]
          ;(void 0 === c || (px(c, mx[s]) && !gx.call(e, s))) && (e[s] = a[s])
        }
      return e
    }),
    bx = UE,
  ...
  var Cx = function (e, t, n) {
      ...
      if (((t = Ex(t)), null == n)) {
        ...
        n = o ? (r ? new a() : []) : _x(e) && Ox(a) ? wx(Sx(e)) : {}
      }
      return (
        (o ? bx : kx)(e, function (e, r, o) {
          return t(n, e, r, o)
        }),
        n
      )
  ...
  var zx = function (e) {
    ...
    Lx = ['view', 'date', 'getNow', 'onNavigate'],
    jx = [
      'view',
      'toolbar',
      'events',
    ...
    function o() {
      ...
      return (
        ...
        (e.handleViewChange = function (t) {
          t !== e.props.view && Fx(t, e.props) && e.props.onView(t)
          var n = e.getViews()
            ...
            value: function (e) {
              ...
              return {
                ...
                components: yx(S[m] || {}, fx(S, O), {
                  ...
                  timeSlotWrapper: t,
                  timeGutterWrapper: t,
                  slotChildrenWrapper: function () {
                    return se.createElement(se.Fragment, null)
                  },
                }),
                accessors: {
                  start: zx(n),
  ...
  var Ux = (function e(t, n, r) {
    ...
    })(Ix, { view: 'onView', date: 'onNavigate', selected: 'onSelectEvent' }),
    Wx = function (e, t, n) {
      var r = e.start,
        o = e.end
