...
var _jsxFileName =
  'C:\\Users\\Pavel Ruzankin\\Desktop\\app\\calendarik\\src\\Agenda.js'
...
function Agenda(_ref) {
  ...
  var renderDay = (day, events, dayKey) => {
    var { event: Event, date: AgendaDate } = components
...
Agenda.range = (start, _ref2) => {
  var { length = Agenda.defaultProps.length } = _ref2
...
Agenda.navigate = (date, action, _ref3) => {
  var { length = Agenda.defaultProps.length } = _ref3
...
Agenda.title = (start, _ref4) => {
  var { length = Agenda.defaultProps.length, localizer } = _ref4
  var end = dates.add(start, length, 'day')
