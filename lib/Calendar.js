...
var Calendar = function (_React$Component) {
  ...
  Calendar.prototype.render = function render() {
    var _props = this.props,
        ...
        current = _props.date,
        props = _objectWithoutProperties(_props, ['view', 'toolbar', 'events', 'culture', 'components', 'formats', 'style', 'className', 'elementProps', 'toolbarProps', 'date']);
...
Calendar.propTypes = {
  ...
  components: _propTypes2.default.shape({
    ...
    agenda: _propTypes2.default.shape({
      wrapper: _propTypes3.elementType,
