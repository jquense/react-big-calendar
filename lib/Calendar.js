...
Calendar.propTypes =
  process.env.NODE_ENV !== 'production'
    ? {
         ...
         * @type {(string|element)}
         */
        nextButtonContent: _propTypes.default.elementType,
         ...
         * @type {(string|element)}
         */
        prevButtonContent: _propTypes.default.elementType,
         ...
         *
         */
        disabledDates: _propTypes.default.arrayOf(_propTypes.default.object),
