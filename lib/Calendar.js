...
var Calendar = _react2.default.createClass({
  ...
  propTypes: {
     ...
     */
    viewAliases: _react.PropTypes.object,
     ...
     * multi view.
     */
    selectedEntityKeys: _react.PropTypes.array,
     ...
     * ```
     */
    onSelectedEntityChange: _react.PropTypes.func,
     ...
     */
    nowTimezone: _react2.default.PropTypes.string,
   ...
   * view aliases.
   */
  getLogicalView: function getLogicalView() {
    var _props = this.props,
        view = _props.view,
        viewAliases = _props.viewAliases;
  ...
  render: function render() {
    var _props3 = this.props,
        ...
        singleDayEventsOnly = _props3.singleDayEventsOnly,
        culture = _props3.culture,
        _props3$components = _props3.components,
        components = _props3$components === undefined ? {} : _props3$components,
        _props3$componentProp = _props3.componentProps,
        componentProps = _props3$componentProp === undefined ? {} : _props3$componentProp,
        _props3$formats = _props3.formats,
        formats = _props3$formats === undefined ? {} : _props3$formats,
        style = _props3.style,
        className = _props3.className,
        elementProps = _props3.elementProps,
        current = _props3.date,
        props = _objectWithoutProperties(_props3, ['view', 'toolbar', 'events', 'singleDayEventsOnly', 'culture', 'components', 'componentProps', 'formats', 'style', 'className', 'elementProps', 'date']);
