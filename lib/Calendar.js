...
var Calendar = function (_React$Component) {
  ...
  Calendar.prototype.render = function render() {
    var _props = this.props,
        ...
        current = _props.date,
        props = _objectWithoutProperties(_props, ['view', 'toolbar', 'events', 'singleDayEventsOnly', 'culture', 'components', 'componentProps', 'formats', 'style', 'className', 'elementProps', 'date']);
