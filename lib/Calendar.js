...
var _jsxFileName =
  'C:\\Users\\Pavel Ruzankin\\Desktop\\app\\calendarik\\src\\Calendar.js'
    ...
    this.getViews = () => {
      ...
      if (Array.isArray(views)) {
        return (0, _transform.default)(
          views,
          (obj, name) => (obj[name] = _Views.default[name]),
          {}
        )
      }
    ...
    return {
      ...
      getters: {
        ...
        backgroundEventProp: function backgroundEventProp() {
          return (
            (backgroundEventPropGetter &&
              backgroundEventPropGetter(...arguments)) ||
            {}
          )
        },
