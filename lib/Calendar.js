...
var Calendar = function (_React$Component) {
  ...
  Calendar.prototype.render = function render() {
    var _props = this.props,
        ...
        current = _props.date,
        props = _objectWithoutProperties(_props, ['view', 'toolbar', 'events', 'culture', 'components', 'formats', 'messages', 'style', 'className', 'elementProps', 'toolbarProps', 'date']);
    ...
    return _react2.default.createElement(
      ...
      toolbar && _react2.default.createElement(CalToolbar, _extends({
        date: current,
        view: view,
        views: names,
        label: label,
...
Calendar.propTypes = {
  ...
  */
  ...
  components: _propTypes2.default.shape({
    ...
    popup: _propTypes3.elementType,

    toolbar: _propTypes3.elementType,

    agenda: _propTypes2.default.shape({
      wrapper: _propTypes3.elementType, date: _propTypes3.elementType,
