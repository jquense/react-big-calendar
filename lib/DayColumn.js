...
var DaySlot = _react2.default.createClass({
  ...
  propTypes: {
    ...
    entityKeyAccessor: _react2.default.PropTypes.string,
  ...
  render: function render() {
    ...
    return _react2.default.createElement(
      ...
      _extends({}, props, {
        className: (0, _classnames2.default)('rbc-day-slot', !isMultiGrid && _dates2.default.isToday(max) && 'rbc-today', _dates2.default.lt(max, _dates2.default.today(), 'day') && 'rbc-past', (_bowser2.default.mobile || _bowser2.default.tablet) && 'rbc-mobile-clickable'),
        now: now,
        min: min,
        max: max,
        step: step,
  ...
  renderEvents: function renderEvents() {
    ...
    var _props2 = this.props,
        ...
        entityKeyAccessor = _props2.entityKeyAccessor;


    var EventComponent = eventComponent;

    var styledEvents = (0, _dayViewLayout2.default)({
      events: events, entityKeyAccessor: entityKeyAccessor, startAccessor: startAccessor, endAccessor: endAccessor, min: min, totalMin: this._totalMin, step: step, rightOffset: rightOffset
    });
    ...
    return styledEvents.map(function (_ref, idx) {
      ...
      var key = entityKeyAccessor ? event[entityKeyAccessor] : 'evt_' + idx;
