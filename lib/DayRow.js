...
var _TimeGridRowEvent = _interopRequireDefault(require("./TimeGridRowEvent"));
...
function (_React$Component) {
  ...
  function DayRow() {
    ...
    _this.renderEvents = function () {
      ...
      return styledEvents.map(function (_ref, idx) {
        ...
        return _react.default.createElement(_TimeGridRowEvent.default, {
          style: style,
          event: event,
          label: label,
          key: 'evt_' + idx,
    ...
    _this._selectable = function () {
      ...
      var selectionState = function selectionState(point) {
        var currentSlot = _this.slotMetrics.closestSlotFromPointForRow(point, (0, _Selection.getBoundsForNode)(node));
  ...
  _proto.render = function render() {
    var _this$props3 = this.props,
        ...
        Wrapper = _this$props3$componen2 === void 0 ? _BackgroundWrapper.default : _this$props3$componen2,
        components = (0, _objectWithoutPropertiesLoose2.default)(_this$props3$componen, ["eventContainerWrapper", "timeSlotWrapper"]);
    ...
    return _react.default.createElement("div", {
      style: style,
      className: (0, _clsx.default)(className, 'rbc-day-slot', 'rbc-time-row', isNow && 'rbc-now', isNow && 'rbc-today', // WHY
...
DayRow.propTypes = process.env.NODE_ENV !== "production" ? {
