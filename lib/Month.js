...
var MonthView = function (_React$Component) {
  ...
  MonthView.prototype.componentWillMount = function componentWillMount() {
    this._bgRows = [];
...
var _initialiseProps = function _initialiseProps() {
  ...
  this._headers = function (row, format, culture) {
    var first = row[0];
    var last = row[row.length - 1];
    var HeaderComponent = _this4.props.components.header || _Header2.default;
  ...
  this._renderOverlay = function () {
    var overlay = _this4.state && _this4.state.overlay || {};
    var components = _this4.props.components;
    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement(_Popup2.default, _extends({}, _this4.props, {
        eventComponent: components.event,
        eventWrapperComponent: components.eventWrapper,
  ...
  this.measureRowLimit = function () {
    _this4.setState({
      needLimitMeasure: false,
      rowLimit: _this4.refs.slotRow.getRowLimit()
    });
  };

  this.handleSelectSlot = function (range) {
  ...
  this._selectDates = function () {
    var slots = _this4._pendingSelection.slice();

    _this4._pendingSelection = [];

    slots.sort(function (a, b) {
      return +a - +b;
    });

    (0, _helpers.notify)(_this4.props.onSelectSlot, {
      slots: slots,
      start: slots[0],
