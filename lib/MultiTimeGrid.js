...
var MultiTimeGrid = function (_Component) {
  ...
  function MultiTimeGrid(props) {
    ...
    _this.onHeaderSelectChange = function (_ref) {
      ...
      _this.setState({ selectedEntityKeys: _this.state.selectedEntityKeys.map(function (selectedEntityKey, i) {
          return i === index ? value : selectedEntityKey;
        }) });
    };
    ...
    _this.onContentScroll = function (_ref2) {
      ...
      if (target.scrollTop !== _this._lastScrollTop) {
        var timeGutter = _this.getTimeGutter();
        if (timeGutter) {
    ...
    _this.state = {
      ...
      isOverflowing: null,
      selectedEntityKeys: _this.props.entities.map(function (entity) {
        return entity[_this.props.entityKeyAccessor];
      })
    };
  ...
  MultiTimeGrid.prototype.render = function render() {
    ...
    var _state = this.state,
        selectedEntityKeys = _state.selectedEntityKeys,
        gutterWidth = _state.gutterWidth;
  ...
  MultiTimeGrid.prototype.renderEvents = function renderEvents(date, rangeEventsMap, today) {
    ...
    return this.state.selectedEntityKeys.map(function (selectedEntityKey, idx) {
  ...
  MultiTimeGrid.prototype.renderHeaderCells = function renderHeaderCells(date) {
    ...
    return this.state.selectedEntityKeys.map(function (selectedEntityKey, i) {
