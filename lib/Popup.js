...
var Popup = function (_React$Component) {
  ...
  Popup.prototype.render = function render() {
    var _props = this.props,
        ...
        CustomContent = _props.popupComponent,
        props = _objectWithoutProperties(_props, ['events', 'selected', 'eventComponent', 'eventWrapperComponent', 'popupComponent']);
    ...
    return CustomContent ? _react2.default.createElement(
      'div',
      { ref: 'root', style: style, className: 'rbc-overlay' },
      _react2.default.createElement(CustomContent, { events: events, date: props.slotStart })
