...
var _InvertedTimeGridHeader = _interopRequireDefault(
  require('./InvertedTimeGridHeader')
)
...
var TimeGrid = /*#__PURE__*/ (function(_Component) {
  ...
  _proto.renderEvents = function renderEvents(
    ...
    var renderDatesAndResources = function renderDatesAndResources(
      now,
      date,
      jj,
      id,
      ...
      var otherDaysEvents = (groupedEvents.get('other') || []).filter(function(
        event
      ) {
        return dates.inRange(
          date,
    ...
    if (invertResourcesAndDates) {
      var resourcesLen = fullTimeResourceIds.length
      ...
      return resources.map(function(_ref2, i) {
        var id = _ref2[0],
          resource = _ref2[1]
        return range.map(function(date, jj) {
  ...
  _proto.render = function render() {
    ...
    var allDayEvents = [],
      rangeEvents = [] // Separate part-time teachers from full-time ones
    ...
    return /*#__PURE__*/ _react.default.createElement(
      ...
      !invertResourcesAndDates
        ...
        : /*#__PURE__*/ _react.default.createElement(
            _InvertedTimeGridHeader.default,
            {
              range: range,
              events: allDayEvents,
              width: width,
