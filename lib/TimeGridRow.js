...
function (_Component) {
  ...
  _proto.render = function render() {
    ...
    var _this$props3 = this.props,
        ...
        ResourceHeaderComponent = _this$props3$componen === void 0 ? _ResourceHeader.default : _this$props3$componen;
    ...
    return _react.default.createElement("div", {
      className: (0, _clsx.default)('rbc-time-view-row', 'rbc-time-row-resource', resources && 'rbc-time-view-resources')
    }, _react.default.createElement("div", {
      className: (0, _clsx.default)('rbc-time-column', 'rbc-time-row-resource-column-xx')
