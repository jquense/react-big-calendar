...
var _TimeGridEvent = _interopRequireDefault(require("../../scheduler/TimeGridEvent"));
...
function (_React$Component) {
  ...
  function EventContainerWrapper() {
    ...
    _this._selectable = function () {
      ...
      selector.on('beforeSelect', function (point) {
        ...
        _this.eventOffsetLeft = point.x - (0, _Selection.getBoundsForNode)(eventNode).left;
      });
  ...
  _proto.render = function render() {
    ...
    return _react.default.cloneElement(children, {
      children: _react.default.createElement(_react.default.Fragment, null, events, event && onSchedulerView && _react.default.createElement(_TimeGridEvent.default, {
        event: event,
        label: label,
      ...
      }), event && !onSchedulerView && _react.default.createElement(_TimeGridEvent2.default, {
        event: event,
        label: label,
        className: "rbc-addons-dnd-drag-preview",
        style: {
