...
function (_React$Component) {
  ...
  _proto.render = function render() {
    ...
    return _react.default.cloneElement(children, {
      children: _react.default.createElement(_react.default.Fragment, null, events, event && onSchedulerView && _react.default.createElement(_TimeGridRowEvent.default, {
        event: event,
        label: label,
      ...
      }), event && !onSchedulerView && _react.default.createElement(_TimeGridEvent.default, {
        event: event,
        label: label,
        className: "rbc-addons-dnd-drag-preview",
        style: {
