...
_createClass2.default)(function DateLocalizer(spec) {
  var _this = this
  ;(0, _classCallCheck2.default)(this, DateLocalizer)
  ;(0,
  _invariant.default)(typeof spec.format === 'function', 'date localizer `format(..)` must be a function')
  ;(0,
  _invariant.default)(typeof spec.firstOfWeek === 'function', 'date localizer `firstOfWeek(..)` must be a function')
