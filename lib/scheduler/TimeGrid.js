...
function (_Component) {
  ...
  _proto.componentWillReceiveProps = function componentWillReceiveProps(nextProps) {
    ...
    if (!dates.eq(nextProps.range[0], range[0], 'minute') || !dates.eq(nextProps.scrollToDay, scrollToDay, 'minute')) {
  ...
  _proto.render = function render() {
    ...
    return _react.default.createElement("div", {
      ...
      return _react.default.createElement(_TimeGridHeader.default, (0, _extends2.default)({
        key: jj
      }, _this4.props, {
        localizer: localizer,
        min: dates.merge(date, min),
