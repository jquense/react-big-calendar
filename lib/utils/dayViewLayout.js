...
function getStyledAvailabilities(_ref8) {
  ...
  var availabilities = unsortedAvailabilities.slice().sort(function (a, b) {
    return new Date((0, _accessors.accessor)(a, availabilityStartAccessor)) - new Date((0, _accessors.accessor)(b, availabilityStartAccessor)) || new Date((0, _accessors.accessor)(a, availabilityEndAccessor)) - new Date((0, _accessors.accessor)(b, availabilityEndAccessor));
  });
