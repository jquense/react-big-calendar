...
var getYStyles = function getYStyles(idx, _ref6) {
   ...
   * Daylite savings
   */
  var startDayStart = _dates2.default.startOf((0, _accessors.accessor)(event, startAccessor), 'day');
  var startDayEnd = _dates2.default.endOf((0, _accessors.accessor)(event, startAccessor), 'day');
  var startDstOffset = startDayStart.getTimezoneOffset() - startDayEnd.getTimezoneOffset();

  var endDayStart = _dates2.default.startOf((0, _accessors.accessor)(event, startAccessor), 'day');
  var endDayEnd = _dates2.default.endOf((0, _accessors.accessor)(event, startAccessor), 'day');
  var endDstOffset = endDayStart.getTimezoneOffset() - endDayEnd.getTimezoneOffset();

  var top = (start + startDstOffset) / totalMin * 100;
  var bottom = (end + endDstOffset) / totalMin * 100;
  ...
  var _loop = function _loop() {
    ...
    childGroups.forEach(function (group) {
      ...
      group.forEach(function (eventIdx, i) {
        ...
        var width = (100 - rightOffset - spaceOccupiedByParent) / columns;
