...
describe('Vertical reorder', () => {
  describe('same span segments', () => {
    ...
    test('when dragging multi pan seg 3,3 to 3,2', () => {
      ...
      // level 4
      expect(nextLevels[4].length).toEqual(1);
      expect(nextLevels[4][0].event).toEqual(8);

      // level 5
      expect(nextLevels[5].length).toEqual(1);
      expect(nextLevels[5][0].event).toEqual(12);
    });
    test('when dragging multi pan seg 3,3 to 3,2', () => {
      const levels = [
        [seg(2, 6, 5, 0, 1), seg(7, 7, 1, 0, 2)],
    ...
    test('when dragging multi pan seg 3,3 to 3,2', () => {
      ...
      const [_, nextLevels] = reorderLevels(levels, drag, hover);
      // level 0
      expect(nextLevels[0].length).toEqual(3);
      expect(nextLevels[0][0].level).toEqual(0);
      expect(nextLevels[0][0].left).toEqual(1);
      expect(nextLevels[0][0].event).toEqual(1);

      expect(nextLevels[0][1].level).toEqual(0);
      expect(nextLevels[0][1].left).toEqual(2);
      expect(nextLevels[0][1].event).toEqual(3);

      expect(nextLevels[0][2].level).toEqual(0);
      expect(nextLevels[0][2].left).toEqual(4);
      expect(nextLevels[0][2].event).toEqual(5);
    });
    test('when dragging multi pan seg 3,3 to 3,2', () => {
      const levels = [
      ...
      expect(nextLevels[1][1].event).toEqual(12);
    ...
    test('when dragging multi pan seg 3,3 to 3,2', () => {
      const levels = [
        [seg(2, 2, 1, 0, 1), seg(4, 4, 1, 0, 2), seg(6, 6, 1, 0, 3), seg(7, 7, 1, 0, 4)],
        [seg(4, 7, 4, 1, 5)],
        [seg(2, 2, 1, 2, 6), seg(4, 4, 1, 2, 7)],
        [seg(2, 6, 5, 3, 8), seg(7, 7, 1, 3, 9)],
        [seg(2, 2, 1, 4, 10), seg(4, 4, 1, 4, 11), seg(7, 7, 1, 4, 12)],
        [seg(4, 4, 1, 5, 13), seg(7, 7, 1, 5, 14)],
      ];
      const drag = levels[2][1];
      const hover = levels[3][0];
      const [_, nextLevels] = reorderLevels(levels, drag, hover);
      expect(nextLevels.length).toEqual(6);
      ...
      expect(nextLevels[3][2].event).toEqual(12);

      // level 4
      expect(nextLevels[4].length).toEqual(2);
      expect(nextLevels[4][0].event).toEqual(11);
      expect(nextLevels[4][1].event).toEqual(14);
    ...
    test('when dragging multi pan seg 3,3 to 3,2', () => {
      const levels = [
        [seg(2, 2, 1, 0, 1), seg(4, 4, 1, 0, 2), seg(6, 6, 1, 0, 3), seg(7, 7, 1, 0, 4)],
        [seg(2, 2, 1, 1, 15), seg(4, 7, 4, 1, 5)],
        [seg(2, 2, 1, 2, 6), seg(7, 7, 1, 2, 7)],
        [seg(2, 6, 5, 3, 8), seg(7, 7, 1, 3, 9)],
        [seg(2, 2, 1, 4, 10), seg(4, 4, 1, 4, 11), seg(6, 6, 1, 5, 16), seg(7, 7, 1, 4, 12)],
        [seg(4, 4, 1, 5, 13), seg(6, 6, 1, 5, 14)],
      ];
      const drag = levels[2][0];
      const hover = levels[1][0];
      const [_, nextLevels] = reorderLevels(levels, drag, hover);
      ...
      expect(nextLevels[5][0].event).toEqual(13);
      expect(nextLevels[5][1].event).toEqual(14);
    });
    test('when dragging multi pan seg 3,3 to 3,2', () => {
      const levels = [
        [
        ...
        [seg(1, 1, 1, 1, 7), seg(2, 2, 1, 1, 8)],
        [seg(1, 1, 1, 2, 9), seg(2, 2, 1, 2, 10)],
        [seg(1, 1, 1, 3, 11), seg(2, 2, 1, 3, 12)],
        [seg(1, 5, 5, 4, 13)],
        [seg(2, 2, 1, 5, 14)],
      ];
      ...
      // level 0
      expect(nextLevels[0].length).toEqual(6);
      expect(nextLevels[0][0].event).toEqual(1);
      expect(nextLevels[0][1].event).toEqual(8);
      expect(nextLevels[0][2].event).toEqual(3);
      expect(nextLevels[0][3].event).toEqual(4);
      expect(nextLevels[0][4].event).toEqual(5);
      expect(nextLevels[0][5].event).toEqual(6);

      // level 1
      expect(nextLevels[1].length).toEqual(2);
      expect(nextLevels[1][0].event).toEqual(7);
      expect(nextLevels[1][1].event).toEqual(10);

      // level 2
      expect(nextLevels[2].length).toEqual(2);
      expect(nextLevels[2][0].event).toEqual(9);
      expect(nextLevels[2][1].event).toEqual(12);

      // level 3
      expect(nextLevels[3].length).toEqual(2);
      expect(nextLevels[3][0].event).toEqual(11);
      expect(nextLevels[3][1].event).toEqual(2);

      // level 4
      expect(nextLevels[4].length).toEqual(1);
      expect(nextLevels[4][0].event).toEqual(13);

      // level 5
      expect(nextLevels[5].length).toEqual(1);
      expect(nextLevels[5][0].event).toEqual(14);
    });
    test('when dragging multi pan seg 3,3 to 3,2', () => {
      const levels = [
    ...
    test('when dragging single to multi span (0,1) to (2,0)', () => {
      ...
      expect(nextLevels[2].length).toEqual(1);
      expect(nextLevels[2][0].event).toEqual(4);
      expect(nextLevels[2][0].left).toEqual(2);
      expect(nextLevels[2][0].right).toEqual(6);
      expect(nextLevels[2][0].span).toEqual(5);

      // level 3
      expect(nextLevels[3].length).toEqual(1);
      expect(nextLevels[3][0].event).toEqual(5);
      expect(nextLevels[3][0].left).toEqual(5);
      expect(nextLevels[3][0].right).toEqual(5);
      expect(nextLevels[3][0].span).toEqual(1);
    });
    /*test('bubble down', () => {
      const levels = [
        [seg(2, 2, 1, 0, 1)],
