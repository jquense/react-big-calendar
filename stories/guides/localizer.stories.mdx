...
You have probably noticed that your Big Calendar implementations require a <LinkTo kind="props" story="localizer">localizer</LinkTo> prop. The `localizer` is needed for applying formatting and culture (i18n) to your date displays throughought the Calendar.
...
- `formats:object`
- `getDstOffeset(start:Date, end:Date) => number`
