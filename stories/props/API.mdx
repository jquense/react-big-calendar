...
Determines whether the drill down should occur when clicking on the "+x more" link.
If popup is false and doShowMoreDrillDown is true, the drill down will occur as usual.
If popup is false and doShowMoreDrillDown is false, the drill down will not occur and onShowMore will trigger.
*/}
